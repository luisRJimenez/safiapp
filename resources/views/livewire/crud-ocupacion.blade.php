<div>
    ...
    <div class="max-w-7xl mx-auto py-2 px-4 sm:px-6 lg:px-8 flex">
        <div class="pr-2">
            ...
            <x-jet-input type="text" placeholder="Tipo de Ocupación" wire:model.defer="ocudescripcion" required></x-jet-input>
            <x-jet-input-error for="ocudescripcion"/>
        </div>
        ...
        <div class="py-1">
            ...
            <x-jet-button disabled wire:dirty.attr.remove="disabled" wire:target="ocudescripcion" wire:click='salvar()'>Grabar</x-jet-button>
            @endif
        </div>
              ...
              <table class="min divide-y divide-gray-200">
                ...
                @forelse ($data as $item)
                  <tr>
                    ...
                    <td class="px-6 py-1 whitespace-nowrap">
                      <div class="text-sm text-gray-900">{{$item ->ocudescripcion}}</div>
                    </td>
