<div>
    ...
    <div class="max-w-7xl mx-auto py-2 px-4 sm:px-6 lg:px-8 flex">
        <div class="pr-2">
            ...
            <x-jet-input type="text" placeholder="Nombre de la Dependencia" wire:model.defer="depdescripcion" class=" min-w-full md:min-w-0"></x-jet-input>

            <x-jet-input-error for="depdescripcion"/>
        </div>
        ...
        <div class="py-1">
            ...
            @else
                <x-jet-button disabled wire:dirty.attr.remove="disabled" wire:target="depdescripcion" wire:click='salvar()'>Grabar</x-jet-button>
            @endif
        </div>
    </div>
              ...
              <table class="min divide-y divide-gray-200">
                ...
                @forelse ($data as $item)
                  <tr>
                    ...
                    <td class="px-6 py-1 whitespace-nowrap">
                      <div class="text-sm text-gray-900">{{$item ->depdescripcion}}</div>
                    </td>
